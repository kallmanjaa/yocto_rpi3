...
DESCRIPTION = "QT5-SVG for RPI3 devices"

LICENSE = "GPL-2.0+"

LIC_FILES_CHKSUM = "file://${WORKDIR}/git/LICENSE.GPL2;md5=b234ee4d69f5fce4486a80fdaf4a4263"

SRC_URI = "git://github.com/qt/qtsvg.git;branch=5.13.2;protocol=http"

SRCREV = "${AUTOREV}"

S = "${WORKDIR}/git"

DEPENDS += "zlib-native zlib libpng-native libpng dbus dbus-native libdrm egl qt5-base qt5-declarative qt5-quickcontrols"
